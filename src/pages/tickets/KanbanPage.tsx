...
import { Avatar, PRIORITY_META, Tag, hashTone, metaFor, type Status } from "@widgets/tickets/kanban-ui";
  ...
  return (
    <ITPage
      ...
      breadcrumbs={[
        ...
        ...(ticketId
          ? [{ label: tt("kanban.ticket"), onClick: () => navigate(`/tickets/${ticketId}`) }, { label: tt("kanban.breadcrumb") }]
            ...
            <div className="space-y-2 min-h-[140px]">
              {byStatus[col.status].length === 0 ? (
                <div className="rounded-xl border border-dashed border-slate-200 p-4 text-center">
                  <ITText className="text-[10px] text-slate-400 italic">{tt("kanban.emptyColumn")}</ITText>
                </div>
              ) : (
      ...
      >
        <div className="pb-3 mb-3 border-b border-slate-100 pr-6">
          <ITFlex align="center" gap={2}>
            ...
            <ITText className="text-lg font-black text-slate-800">{tt("kanban.newTask")}</ITText>
          </ITFlex>
          ...
          <ITGrid item xs={12}>
            <ITFlex justify="end" gap={2}>
              ...
              >
                <ITFlex align="center" gap={1}>
                  <FaUserPlus size={11} />
                  <ITText className="font-bold text-[10px]">{creatingTask ? tt("kanban.assigning") : tt("kanban.assignTask")}</ITText>
                </ITFlex>
              </ITButton>
            </ITFlex>
          </ITGrid>
